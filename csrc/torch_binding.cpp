...
std::tuple<at::Tensor, at::Tensor, at::Tensor, at::Tensor> dispatch_prefill(
    ...
    // Return values
    return {expandx_out, expand_idx_out, recv_count_, recv_tokens_per_expert_};
}
...
TORCH_LIBRARY_EXPAND(CONCAT(_C, _ascend), ops)
{
    ...
    ops.def(
        ...
        "(Tensor expandx_out, Tensor expand_idx_out, Tensor recv_count, Tensor recv_tokens_per_expert)");
